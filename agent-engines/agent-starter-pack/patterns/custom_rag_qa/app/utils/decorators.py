...
class CustomAgent:
    ...
    def __init__(self, func: Callable):
        """Initialize the CustomAgent with a callable function."""
        self.func = func
    ...
    def __call__(self, *args: Any, **kwargs: Any) -> Any:
        """Make the CustomAgent instance callable, invoking the wrapped function."""
        return self.func(*args, **kwargs)


def custom_agent(func: Callable) -> CustomAgent:
    """
    Decorator function that wraps a callable in a CustomAgent instance.
    """
